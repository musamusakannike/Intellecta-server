...
async function sendVerificationEmail(user) {
  ...
  // Compose email
  const verificationLink = `${process.env.BASE_URL}/api/v1/auth/verify-email?token=${tokenString}&id=${user._id}`;
  ...
  const mailOptions = {
    ...
    html: `
      ...
      <head>
        ...
        <title>Verify Your Intellecta Email</title>
        <style>
          body {
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-content">
            <div class="email-greeting">Welcome to the Universe of Knowledge</div>
            <div class="email-message">
              You're just one step away from exploring the cosmos of information with Intellecta. 
              Please verify your email address to activate your account and begin your journey through the stars of intellect.
            </div>
          ...
          <div class="email-footer">
            ...
            This email was sent because someone signed up for Intellecta using this email address.
          </div>
        </div>
      </body>
      </html>
